...
In this section, you'll plan how you can apply machine learning to your project. You're not required to actually implement machine learning in this checkpoint, but this checkpoint will help identify issues that you may encounter when you do implement machine learning, or issues with your current datasets that will need to be addressed before you can implement machine learning.
