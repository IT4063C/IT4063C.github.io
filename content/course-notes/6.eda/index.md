...
## What is EDA?
- In the beginning there was hypothesis testing (confirmatory data analysis)
*Explain what that is here*
This is when you have a hypothesis or a theory about a population. You take 

- John Tukey in 1961 found that there was a need for a kind of analysis where the hypotheses were suggested by the data.
- Tukey introduced a new scientific discipline that was then coined as "Exploratory data analysis" as opposed to "confirmatory data analysis".
...
![png](_index_files/output_37_0.png)
...
![png](_index_files/output_39_1.png)
...
![png](_index_files/output_49_1.png)
...
![png](_index_files/output_55_1.png)
