...
## Installing `pip`
You may need to install pip indivudually if it didn't come with the python installation. You can do that by running the following command in your terminal
